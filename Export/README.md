...
### Age calculation
  ...
  - **DRAC** <img height=15px src='../images/web_service.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />Dose
    rate and luminescence age calculator (v1.2 | Windows, Linux, macOS)
...
### Chronological modelling
  ...
  - **ArchaeoChron** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />Provides
    a list of functions for the Bayesian modeling of archaeological
  ...
  - **ArchaeoPhases** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />Provides
    a list of functions for the statistical analysis of archaeological
  ...
  - **BayLum** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />Bayesian
  ...
  - **ChronoModel** <img height=15px src='../images/application.svg' />
    <img height=15px src='../images/status_active.svg' />
  ...
  - **RChronoModel** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />Provides
    a list of functions for the statistical analysis and the
...
### Dose rate modelling
  ...
  - **DosiVox** <img height=15px src='../images/application.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />A Geant
    ...
    1–10.</small>*
  - **DosiVox2D** <img height=15px src='../images/application.svg' />
    <img height=15px src='../images/status_unpublished.svg' /> <br />A
    Geant 4-based software for dosimetry simulations relevant to
    luminescence and ESR dating techniques; simplified version in
    comparison to DosiVox (v2018-12-03 | Linux)
    <br /><img width=20px src='../images/url_valid.svg' />
    <http://www.iramat-crp2a.cnrs.fr/spip/spip.php?article144&lang=fr>
    <br />
  - **RCarb** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' />
...
### ESR data analysis
  ...
  - **ESR** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_unpublished.svg' /> <br />R
  ...
  - **MCDoseE** <img height=15px src='../images/application.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />Dose
...
### Gamma-ray spectrometry
  ...
  - **gammaSpec** <img height=15px src='../images/r_scripts.svg' />
    <img height=15px src='../images/status_unpublished.svg' /> <br />A
...
### Luminescence data analysis
  ...
  - **Analyst** <img height=15px src='../images/application.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />The
    standard programme to analyse luminescence data (v4.57 | Windows)
    <br /><img width=20px src='../images/url_valid.svg' />
  ...
  - **Luminescence** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />A
    ...
    analysis and plotting of equivalent dose distributions. (v0.8.6 |
    Windows, Linux, macOS)
    <br /><img width=20px src='../images/url_valid.svg' />
  ...
  - **numOSL** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />Package
    for optimizing regular numeric problems in optically stimulated
  ...
  - **PTanalyse** <img height=15px src='../images/application.svg' />
    <img height=15px src='../images/status_active.svg' />
    <br />Proprietary software to analyse TR-OSL data (v1.51 | Windows)
    <br /><img width=20px src='../images/url_valid.svg' />
    <https://www.nutech.dtu.dk/english/products-and-services/radiation-instruments/tl_osl_reader/software>
    <br />*<small> </small>*
  - **RLanalyse** <img height=15px src='../images/application.svg' />
    <img height=15px src='../images/status_active.svg' />
    <br />Proprietary software to analyse radiofluorescence data
    (BIN/BINX-file input required) (v1.3 | Windows)
    <br /><img width=20px src='../images/url_valid.svg' />
    <https://www.nutech.dtu.dk/english/products-and-services/radiation-instruments/tl_osl_reader/software>
    <br />*<small> </small>*
  - **tgcd** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' />
  ...
  - **TLdating** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />A series
    of function to make thermoluminescence dating using the MAAD or the
    SAR protocol. This package completes the R package “Luminescence.”
...
### Luminescence data visualisation
  ...
  - **Viewer** <img height=15px src='../images/application.svg' />
    <img height=15px src='../images/status_abandoned.svg' />
  ...
  - **Viewer+** <img height=15px src='../images/application.svg' />
    <img height=15px src='../images/status_active.svg' />
    <br />Proprietary software to visualise luminescence data recorded
    in BIN/BINX-files; sucessor of Viewer (v1.43 | Windows)
    <br /><img width=20px src='../images/url_valid.svg' />
    <https://www.nutech.dtu.dk/english/products-and-services/radiation-instruments/tl_osl_reader/software>
    <br />*<small> </small>*
...
### Miscellaneous
  ...
  - **XRFanalyse** <img height=15px src='../images/application.svg' />
    <img height=15px src='../images/status_active.svg' />
    <br />Proprietary software to analyse XRF data recorded with a Risø
    OSL/TL attachement (v1.12 | Windows)
    <br /><img width=20px src='../images/url_valid.svg' />
    <https://www.nutech.dtu.dk/english/products-and-services/radiation-instruments/tl_osl_reader/software>
    <br />*<small> </small>*
...
### Modelling
  ...
  - **KMS** <img height=15px src='../images/r_scripts.svg' />
    <img height=15px src='../images/status_active.svg' />
    <br />Collection of functions to simulate kinetic models for quartz
    luminescence production (v2018-07-11 | Windows, Linux, macOS)
    <br /><img width=20px src='../images/url_valid.svg' />
  ...
  - **RLumModel** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />A
    collection of functions to simulate luminescence signals in quartz
    and Al2O3 based on published models. (v0.2.3 | Windows, Linux,
    macOS) <br /><img width=20px src='../images/url_valid.svg' />
...
### Plotting
  ...
  - **RLumShiny** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />A
    collection of ‘shiny’ applications for the R package ‘Luminescence’.
...
### Teaching
  ...
  - **LumReader** <img height=15px src='../images/r_package.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />A series
    of functions to estimate the detection windows of a luminescence
    reader based on the filters and the photomultiplier (PMT) selected.
    These functions also allow to simulate a luminescence experiment
    based on the thermoluminesce (TL) or the optically stimulated
    luminescence (OSL) properties of a material. (v0.1.0 | Windows,
...
### Visualisation
  ...
  - **DensityPlotter**
    <img height=15px src='../images/application.svg' />
    <img height=15px src='../images/status_active.svg' /> <br />Java
