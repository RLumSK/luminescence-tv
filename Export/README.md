...
-   <b><big>OCTOPUS</b></big>
    ...
    2123–2139. doi: <https://doi.org/10.5194/essd-10-2123-2018></small>*
    <hr/>
...
-   <b><big>DosiVox2D</b></big>
    ...
    <hr/>
-   <b><big>RCarb</b></big>
    \[0.1.4\] ![](images/osi_logo.png) <img width=79px src='images/badges_r_package.svg' /> <img width=70px src='images/badges_sta_stable.svg' /> ![](https://img.shields.io/badge/-WIN-lightgrey.svg) ![](https://img.shields.io/badge/-MAC-lightgrey.svg) ![](https://img.shields.io/badge/-LIN-lightgrey.svg) 
...
-   <b><big>gamma</b></big> \[1.0.0\] \[
    ...
    <br />Process in-situ Gamma-Ray Spectrometry for Luminescence
    Dating. This package allows to import, inspect and correct the
    energy shifts of Gamma-ray spectra. It provides methods for
    estimating the gamma dose rate by the use of a calibration curve.
...
-   <b><big>gammaSpec</b></big>
    ...
    <hr/>
-   <b><big>rxylib</b></big>
    \[0.2.6\] ![](images/osi_logo.png) <img width=79px src='images/badges_r_package.svg' /> <img width=70px src='images/badges_sta_stable.svg' /> ![](https://img.shields.io/badge/-WIN-lightgrey.svg) ![](https://img.shields.io/badge/-MAC-lightgrey.svg) ![](https://img.shields.io/badge/-LIN-lightgrey.svg) 
...
-   <b><big>LDAC</b></big>
    ...
    *<small>Liang, P., Forman, S.L., 2019. LDAC: An Excel-based program
    for luminescence equivalent dose and burial age calculations.
    Ancient TL 37, 21–40.</small>*
    <hr/>
-   <b><big>Luminescence</b></big>
    \[0.9.7\] ![](images/osi_logo.png) <img width=79px src='images/badges_r_package.svg' /> <img width=70px src='images/badges_sta_stable.svg' /> ![](https://img.shields.io/badge/-WIN-lightgrey.svg) ![](https://img.shields.io/badge/-MAC-lightgrey.svg) ![](https://img.shields.io/badge/-LIN-lightgrey.svg) 
...
-   <b><big>PTanalyse</b></big>
    ...
    <br /> *<small>Lapp, T., Jain, M., Ankjærgaard, C., Pirtzel,
    L., 2009. Development of pulsed stimulation and Photon Timer
    attachments to the Risø TL/OSL reader. Radiation Measurements 44,
    571–575. doi:
...
-   <b><big>TLdating</b></big>
    \[0.1.3\] \[2016-08-31\] ![](images/osi_logo.png) <img width=79px src='images/badges_r_package.svg' /> <img width=70px src='images/badges_sta_ancient.svg' /> ![](https://img.shields.io/badge/-WIN-lightgrey.svg) ![](https://img.shields.io/badge/-MAC-lightgrey.svg) ![](https://img.shields.io/badge/-LIN-lightgrey.svg) 
    <br />
...
-   <b><big>RLumModel</b></big>
    \[0.2.7\] ![](images/osi_logo.png) <img width=79px src='images/badges_r_package.svg' /> <img width=70px src='images/badges_sta_stable.svg' /> ![](https://img.shields.io/badge/-WIN-lightgrey.svg) ![](https://img.shields.io/badge/-MAC-lightgrey.svg) ![](https://img.shields.io/badge/-LIN-lightgrey.svg) 
